...
WORKINGdir = '/scratch/tolugboj_lab/Prj5_HarnomicRFTraces/Hawaii/ATaCR_lu/datacache_day_preproc/';
% output directory for spectra
OUTdir = '/scratch/tolugboj_lab/Prj5_HarnomicRFTraces/Hawaii/ATaCR_lu/NOISETC_Orient/';
 % directory for figure output
FIGdir = '/scratch/tolugboj_lab/Prj5_HarnomicRFTraces/Hawaii/ATaCR_lu/FIGURES/NOISETC_Orient';


% information for station
net = 'YS'; 
network='YS';
stations = textread('./stalist_YS_test2.txt','%s'); 
...
% not using
tiltfreq = [1/50,1/8];
%tiltfreq = [1/100, 1/3]; % specifying frequency ranges for maximum coherence search
